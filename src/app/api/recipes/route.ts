...
function generateMockRecipes(ingredients: string[]) {
  const recipeTemplates = [
    {
      ...
      possibleIngredients: ["pasta", "tomatoes", "bell peppers", "onions", "garlic", "olive oil", "cheese", "basil"],
      cookTime: "25 minutes",
    ...
    },
    {
      ...
      possibleIngredients: ["bell peppers", "onions", "garlic", "olive oil", "soy sauce", "rice", "carrots"],
      cookTime: "20 minutes",
    ...
    {
      title: "Caprese Salad",
      possibleIngredients: ["tomatoes", "basil", "olive oil", "cheese", "balsamic vinegar"],
      cookTime: "10 minutes",
    ...
    {
      title: "Tomato Soup",
      possibleIngredients: ["tomatoes", "onions", "garlic", "olive oil", "basil", "cream", "vegetable stock"],
      cookTime: "35 minutes",
    ...
    },
    {
      ...
      possibleIngredients: ["eggs", "cheese", "onions", "bell peppers", "olive oil", "salt", "pepper"],
      cookTime: "15 minutes",
  ...
  return recipeTemplates
    .map((template) => {
      const matchedIngredients = ingredients.filter((ing) => template.possibleIngredients.includes(ing))

      const missingIngredients = template.possibleIngredients.filter((ing) => !ingredients.includes(ing))
